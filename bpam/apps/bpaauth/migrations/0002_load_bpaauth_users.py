...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        call_command("loaddata", "bpaauth_users.json")
    ...
    models = {
        ...
        u'BASE.soilsample': {
            ...
            'note': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'protocol': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['common.Protocol']", 'null': 'True', 'blank': 'True'}),
        ...
        u'bpaauth.bpauser': {
            ...
            'affiliations': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
        ...
        u'common.facility': {
            'Meta': {'unique_together': "(('name', 'service'),)", 'object_name': 'Facility'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'common.protocol': {
            'Meta': {'unique_together': "(('library_type', 'base_pairs', 'library_construction_protocol'),)", 'object_name': 'Protocol'},
