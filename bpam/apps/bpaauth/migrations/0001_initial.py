...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bpaauth_bpauser', (
            ...
            ('department', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ...
            ('affiliations', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
