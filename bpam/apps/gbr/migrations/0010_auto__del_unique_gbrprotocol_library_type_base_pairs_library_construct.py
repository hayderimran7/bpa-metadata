...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Removing unique constraint on 'GBRProtocol', fields ['library_type', 'base_pairs', 'library_construction_protocol']
        db.delete_unique(u'gbr_gbrprotocol', ['library_type', 'base_pairs', 'library_construction_protocol'])

        # Adding unique constraint on 'GBRProtocol', fields ['library_type', 'base_pairs_string', 'library_construction_protocol']
        db.create_unique(u'gbr_gbrprotocol', ['library_type', 'base_pairs_string', 'library_construction_protocol'])


    def backwards(self, orm):
        # Removing unique constraint on 'GBRProtocol', fields ['library_type', 'base_pairs_string', 'library_construction_protocol']
        db.delete_unique(u'gbr_gbrprotocol', ['library_type', 'base_pairs_string', 'library_construction_protocol'])

        # Adding unique constraint on 'GBRProtocol', fields ['library_type', 'base_pairs', 'library_construction_protocol']
        db.create_unique(u'gbr_gbrprotocol', ['library_type', 'base_pairs', 'library_construction_protocol'])
    ...
    models = {
        ...
        u'gbr.gbrprotocol': {
            'Meta': {'unique_together': "(('library_type', 'base_pairs_string', 'library_construction_protocol'),)",
                     'object_name': 'GBRProtocol'},
            'base_pairs': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'base_pairs_string': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'gbr.gbrsample': {
            ...
            'protocol': (
            'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gbr.GBRProtocol']", 'null': 'True'}),
