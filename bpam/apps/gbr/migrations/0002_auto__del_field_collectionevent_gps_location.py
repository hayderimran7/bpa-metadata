...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Deleting field 'CollectionEvent.gps_location'
        db.delete_column(u'gbr_collectionevent', 'gps_location')


    def backwards(self, orm):
        # Adding field 'CollectionEvent.gps_location'
        db.add_column(u'gbr_collectionevent', 'gps_location',
