...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'GBRProtocol.base_pairs_string'
        db.add_column(u'gbr_gbrprotocol', 'base_pairs_string',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GBRProtocol.base_pairs_string'
        db.delete_column(u'gbr_gbrprotocol', 'base_pairs_string')
