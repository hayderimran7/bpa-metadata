...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'gbr_collectionevent', (
            ...
            ('collector',
             self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='collector', null=True,
        ...
        db.create_table(u'gbr_gbrsample', (
            ...
            ('contact_bioinformatician',
             self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bioinformatician',
                                                                   null=True, to=orm['bpaauth.BPAUser'])),
        ))
        ...
        db.create_table(u'gbr_gbrrun', (
            ...
            ('array_analysis_facility',
             self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True,
                                                                   to=orm['common.Facility'])),
            ('sequencer',
             self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Sequencer'], null=True, blank=True)),
        ...
        db.create_table(u'gbr_gbrprotocol', (
            ...
            ('note', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('run', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gbr.GBRRun'], null=True, blank=True)),
        ))
    ...
    models = {
        ...
        u'gbr.collectionevent': {
            'Meta': {'unique_together': "(('site_name', 'collection_date'),)", 'object_name': 'CollectionEvent'},
