...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        # Changing field 'CollectionSite.lat'
        db.alter_column(u'gbr_collectionsite', 'lat', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'CollectionSite.lon'
        db.alter_column(u'gbr_collectionsite', 'lon', self.gf('django.db.models.fields.FloatField')(default=999))
        # Adding unique constraint on 'CollectionSite', fields ['lat', 'lon']
        db.create_unique(u'gbr_collectionsite', ['lat', 'lon'])

        # Adding field 'GBRSample.sequencing_facility'
        db.add_column(u'gbr_gbrsample', 'sequencing_facility',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Facility'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'CollectionSite', fields ['lat', 'lon']
        db.delete_unique(u'gbr_collectionsite', ['lat', 'lon'])


        # Changing field 'CollectionSite.lat'
        db.alter_column(u'gbr_collectionsite', 'lat', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'CollectionSite.lon'
        db.alter_column(u'gbr_collectionsite', 'lon', self.gf('django.db.models.fields.FloatField')(null=True))
        ...
        # Deleting field 'GBRSample.sequencing_facility'
        db.delete_column(u'gbr_gbrsample', 'sequencing_facility_id')
    ...
    models = {
        ...
        u'gbr.gbrsample': {
            ...
            'sequencing_facility': (
            'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['common.Facility']", 'null': 'True'}),
