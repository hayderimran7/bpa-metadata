...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Removing unique constraint on 'CollectionEvent', fields ['site_name', 'collection_date']
        db.delete_unique(u'gbr_collectionevent', ['site_name', 'collection_date'])

        # Adding model 'CollectionSite'
        db.create_table(u'gbr_collectionsite', (
        ...
        db.send_create_signal(u'gbr', ['CollectionSite'])

        # Adding unique constraint on 'CollectionSite', fields ['site_name', 'lat', 'lon']
        db.create_unique(u'gbr_collectionsite', ['site_name', 'lat', 'lon'])

        # Adding field 'CollectionEvent.site'
        db.add_column(u'gbr_collectionevent', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gbr.CollectionSite'], null=True),
                      keep_default=False)

        # Adding unique constraint on 'CollectionEvent', fields ['site_name', 'collection_date', 'lat', 'lon']
        db.create_unique(u'gbr_collectionevent', ['site_name', 'collection_date', 'lat', 'lon'])


    def backwards(self, orm):
        # Removing unique constraint on 'CollectionEvent', fields ['site_name', 'collection_date', 'lat', 'lon']
        db.delete_unique(u'gbr_collectionevent', ['site_name', 'collection_date', 'lat', 'lon'])

        # Removing unique constraint on 'CollectionSite', fields ['site_name', 'lat', 'lon']
        db.delete_unique(u'gbr_collectionsite', ['site_name', 'lat', 'lon'])

        # Deleting model 'CollectionSite'
        db.delete_table(u'gbr_collectionsite')

        # Deleting field 'CollectionEvent.site'
        db.delete_column(u'gbr_collectionevent', 'site_id')

        # Adding unique constraint on 'CollectionEvent', fields ['site_name', 'collection_date']
        db.create_unique(u'gbr_collectionevent', ['site_name', 'collection_date'])
    ...
    models = {
        ...
        u'gbr.collectionevent': {
            'Meta': {'unique_together': "(('site_name', 'collection_date', 'lat', 'lon'),)",
                     'object_name': 'CollectionEvent'},
            'collection_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'collector': ('django.db.models.fields.related.ForeignKey', [],
                          {'blank': 'True', 'related_name': "'collector'", 'null': 'True',
            ...
            'note': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'site': (
            'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gbr.CollectionSite']", 'null': 'True'}),
            'site_name': (
        ...
        u'gbr.collectionsite': {
            'Meta': {'unique_together': "(('site_name', 'lat', 'lon'),)", 'object_name': 'CollectionSite'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lat': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'lon': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'note': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        u'gbr.gbrprotocol': {
            'Meta': {'unique_together': "(('library_type', 'base_pairs', 'library_construction_protocol'),)",
                     'object_name': 'GBRProtocol'},
            ...
            'note': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'run': ('django.db.models.fields.related.ForeignKey', [],
                    {'to': u"orm['gbr.GBRRun']", 'null': 'True', 'blank': 'True'})
        },
        u'gbr.gbrrun': {
            ...
            'sequencer': ('django.db.models.fields.related.ForeignKey', [],
                          {'to': u"orm['common.Sequencer']", 'null': 'True', 'blank': 'True'}),
        ...
        u'gbr.gbrsample': {
            ...
            'bpa_id': ('django.db.models.fields.related.OneToOneField', [],
                       {'to': u"orm['common.BPAUniqueID']", 'unique': 'True', 'primary_key': 'True'}),
            'collection_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'collection_event': (
            'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gbr.CollectionEvent']", 'null': 'True'}),
            ...
            'organism': (
            'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['common.Organism']", 'null': 'True'}),
