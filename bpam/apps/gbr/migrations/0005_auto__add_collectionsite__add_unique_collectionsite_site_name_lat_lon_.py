...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'gbr.collectionevent': {
            'Meta': {'unique_together': "(('site_name', 'collection_date', 'lat', 'lon'),)", 'object_name': 'CollectionEvent'},
        ...
        u'gbr.gbrprotocol': {
            ...
            'note': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'run': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gbr.GBRRun']", 'null': 'True', 'blank': 'True'})
        },
        u'gbr.gbrrun': {
