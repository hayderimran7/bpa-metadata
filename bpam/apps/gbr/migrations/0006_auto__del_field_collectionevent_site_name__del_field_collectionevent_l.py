...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        # Deleting field 'CollectionEvent.site_name'
        db.delete_column(u'gbr_collectionevent', 'site_name')

        # Deleting field 'CollectionEvent.lat'
        db.delete_column(u'gbr_collectionevent', 'lat')

        # Deleting field 'CollectionEvent.lon'
        db.delete_column(u'gbr_collectionevent', 'lon')


    def backwards(self, orm):
        # Adding field 'CollectionEvent.site_name'
        db.add_column(u'gbr_collectionevent', 'site_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CollectionEvent.lat'
        db.add_column(u'gbr_collectionevent', 'lat',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'CollectionEvent.lon'
        db.add_column(u'gbr_collectionevent', 'lon',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)
