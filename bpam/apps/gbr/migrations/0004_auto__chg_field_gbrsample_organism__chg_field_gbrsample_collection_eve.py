...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'gbr_gbrsample', 'organism_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Organism'], null=True))

        # Changing field 'GBRSample.collection_event'
        db.alter_column(u'gbr_gbrsample', 'collection_event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gbr.CollectionEvent'], null=True))

    def backwards(self, orm):

        # Changing field 'GBRSample.organism'
        db.alter_column(u'gbr_gbrsample', 'organism_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['common.Organism']))

        # User chose to not deal with backwards NULL issues for 'GBRSample.collection_event'
        raise RuntimeError("Cannot reverse this migration. 'GBRSample.collection_event' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'GBRSample.collection_event'
        db.alter_column(u'gbr_gbrsample', 'collection_event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gbr.CollectionEvent']))
