    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(max_length=1,
                                            choices=[(b'M', b'Male'), (b'F', b'Female'), (b'U', b'Unknown')])),
            ], ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_scientist', models.ForeignKey(related_name='melanoma_melanomasample_sample',
                                                        blank=True,
                                                        to=settings.AUTH_USER_MODEL,
                                                        null=True)),
                ('dna_source', models.ForeignKey(related_name='melanoma_melanomasample_sample',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url_verification', models.ForeignKey(related_name='melanoma_melanomasequencefile_related',
        ...
        migrations.AddField(model_name='melanomasample',
                            name='tumor_stage',
                            field=models.ForeignKey(to='melanoma.TumorStage', null=True), ),
        migrations.AddField(model_name='melanomarun',
                            name='sample',
