...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'wheat_cultivars_cultivarprotocol', (
            ...
            ('run',
             self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wheat_cultivars.CultivarRun'], null=True,
                                                                   blank=True)),
        ))
        ...
        db.create_unique(u'wheat_cultivars_cultivarprotocol',
                         ['library_type', 'base_pairs', 'library_construction_protocol'])
        ...
        db.create_table(u'wheat_cultivars_cultivarrun', (
            ...
            ('protocol',
             self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wheat_cultivars.CultivarProtocol'],
    ...
    def backwards(self, orm):
        ...
        db.delete_unique(u'wheat_cultivars_cultivarprotocol',
                         ['library_type', 'base_pairs', 'library_construction_protocol'])
    ...
    models = {
        ...
        u'wheat_cultivars.cultivarprotocol': {
            ...
            'run': ('django.db.models.fields.related.ForeignKey', [],
                    {'to': u"orm['wheat_cultivars.CultivarRun']", 'null': 'True', 'blank': 'True'})
        },
        u'wheat_cultivars.cultivarrun': {
            ...
            'protocol': ('django.db.models.fields.related.ForeignKey', [],
                         {'to': u"orm['wheat_cultivars.CultivarProtocol']", 'null': 'True', 'blank': 'True'}),
            'run_number': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'sample': (
            'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wheat_cultivars.CultivarSample']"}),
