    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(help_text=b'BPA Project description', max_length=2000, verbose_name='Description', blank=True)),
        ...
        migrations.CreateModel(
            name='BPAUniqueID',
            fields=[
                ('bpa_id', models.CharField(primary_key=True, serialize=False, max_length=200, help_text=b'Unique BPA ID', unique=True, verbose_name='BPA ID')),
                ('note', models.TextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(help_text=b'Facility short name', unique=True, max_length=100, verbose_name='Facility Name')),
                ('note', models.TextField(blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organism_class', models.CharField(max_length=100, verbose_name='Class', blank=True)),
                ('order', models.CharField(max_length=100, blank=True)),
                ('family', models.CharField(max_length=100, blank=True)),
                ('genus', models.CharField(max_length=100, blank=True)),
                ('species', models.CharField(max_length=100, blank=True)),
                ('ncbi_classification', models.URLField(verbose_name=b'NCBI Organismal Classification', blank=True)),
                ('note', models.TextField(blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Sequencer',
            fields=[
                ('name', models.CharField(help_text=b'The sequencer name', max_length=100, serialize=False, primary_key=True)),
