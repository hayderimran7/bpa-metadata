...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'BASE_collectionsitehistory', (
            ...
            ('previous_land_use', self.gf('django.db.models.fields.related.ForeignKey')(related_name='previous', to=orm['BASE.LandUse'])),
            ('current_land_use', self.gf('django.db.models.fields.related.ForeignKey')(related_name='current', to=orm['BASE.LandUse'])),
        ...
        db.create_table(u'BASE_collectionsite', (
            ...
            ('australian_classification_soil_type', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('history', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['BASE.CollectionSiteHistory'], null=True)),
        ...
        db.send_create_signal(u'BASE', ['MetagenomicsSequenceFile'])
        ...
        db.create_table(u'BASE_soilsampledna', (
            ...
            ('target_gene', self.gf('django.db.models.fields.related.ForeignKey')(related_name='target', to=orm['BASE.TargetGene'])),
            ('target_subfragment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subfragment', to=orm['BASE.TargetGene'])),
            ...
            ('forward_primer_sequence', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('reverse_primer_sequence', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.create_table(u'BASE_sample454', (
            ...
            ('dna_storage_nunc_plate', self.gf('django.db.models.fields.CharField')(default='', max_length=12, null=True, blank=True)),
            ('dna_storage_nunc_tube', self.gf('django.db.models.fields.CharField')(default='', max_length=12, null=True, blank=True)),
            ('dna_storage_nunc_well_location', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('agrf_batch_number', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
            ('submitter', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='454_submitter', null=True, to=orm['bpaauth.BPAUser'])),
            ('date_received', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('adelaide_extraction_sample_weight', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ...
            ('adelaide_date_shipped_to_ramacciotti', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
    ...
    models = {
        ...
        u'BASE.metagenomicssequencefile': {
        ...
        u'BASE.sample454': {
            ...
            'adelaide_date_shipped_to_agrf_454': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'adelaide_date_shipped_to_agrf_miseq': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'adelaide_date_shipped_to_ramacciotti': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'adelaide_extraction_sample_weight': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            ...
            'agrf_batch_number': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
            ...
            'brisbane_16s_mid': ('django.db.models.fields.CharField', [], {'max_length': '7', 'null': 'True', 'blank': 'True'}),
            ...
            'brisbane_its_mid': ('django.db.models.fields.CharField', [], {'max_length': '7', 'null': 'True', 'blank': 'True'}),
            ...
            'dna_storage_nunc_plate': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '12', 'null': 'True', 'blank': 'True'}),
            'dna_storage_nunc_tube': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '12', 'null': 'True', 'blank': 'True'}),
            'dna_storage_nunc_well_location': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'note': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'sample_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'submitter': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'454_submitter'", 'null': 'True', 'to': u"orm['bpaauth.BPAUser']"})
        },
        ...
        u'BASE.soilsampledna': {
            ...
            'protocol_ref': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
