...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'PathogenSample.index'
        db.add_column(u'wheat_pathogens_pathogensample', 'index',
                      self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PathogenSample.index'
        db.delete_column(u'wheat_pathogens_pathogensample', 'index')
