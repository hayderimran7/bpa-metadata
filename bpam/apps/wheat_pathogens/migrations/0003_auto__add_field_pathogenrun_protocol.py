...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'PathogenRun.protocol'
        db.add_column(u'wheat_pathogens_pathogenrun', 'protocol',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wheat_pathogens.PathogenProtocol'],
                                                                            null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PathogenRun.protocol'
        db.delete_column(u'wheat_pathogens_pathogenrun', 'protocol_id')
    ...
    models = {
        ...
        u'wheat_pathogens.pathogenprotocol': {
            ...
            'note': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'run': ('django.db.models.fields.related.OneToOneField', [],
                    {'to': u"orm['wheat_pathogens.PathogenRun']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'wheat_pathogens.pathogenrun': {
            ...
            'protocol': ('django.db.models.fields.related.ForeignKey', [],
                         {'to': u"orm['wheat_pathogens.PathogenProtocol']", 'null': 'True', 'blank': 'True'}),
            'run_number': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'sample': (
            'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wheat_pathogens.PathogenSample']"}),
