    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DNA_extraction_protocol', models.CharField(max_length=200,
                                                             ...
                                                             blank=True)),
                ('passage_number', models.IntegerField(null=True, verbose_name='Passage Number',
                                                       blank=True)),
                ('run_number', models.IntegerField(null=True, blank=True)),
                ('flow_cell_id', models.CharField(max_length=10, verbose_name='Flow Cell ID',
                                                  blank=True)),
                ('array_analysis_facility', models.ForeignKey(related_name='+',
                                                              verbose_name='Array Analysis',
                                                              blank=True,
                                                              to='common.Facility',
                                                              null=True)),
                ('protocol', models.ForeignKey(blank=True, to='wheat_pathogens.PathogenProtocol',
                                               null=True)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('debug_note', models.TextField(null=True, verbose_name='Original Data',
                                                blank=True)),
                ('official_variety_name', models.CharField(max_length=200, null=True,
                                                           blank=True)),
                ('original_source_host_species', models.CharField(max_length=200, null=True,
                                                                  blank=True)),
                ('collection_location', models.CharField(max_length=200, null=True,
                                                         blank=True)),
                ('sample_label', models.CharField(max_length=200, null=True, blank=True)),
                ('wheat_pathogenicity', models.CharField(max_length=200, null=True,
                                                         blank=True)),
                ...
                ('contact_scientist', models.ForeignKey(related_name='wheat_pathogens_pathogensample_sample',
                                                        blank=True,
                                                        to=settings.AUTH_USER_MODEL,
                                                        null=True)),
                ('dna_source', models.ForeignKey(related_name='wheat_pathogens_pathogensample_sample',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url_verification', models.ForeignKey(related_name='wheat_pathogens_pathogensequencefile_related',
        ...
        migrations.AddField(model_name='pathogenrun',
                            name='sample',
