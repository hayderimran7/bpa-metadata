...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'wheat_pathogens_pathogenprotocol', (
            ...
            ('run', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wheat_pathogens.PathogenRun'],
        ...
        db.create_unique(u'wheat_pathogens_pathogenprotocol',
    ...
    def backwards(self, orm):
        ...
        db.delete_unique(u'wheat_pathogens_pathogenprotocol',
                         ['library_type', 'base_pairs', 'library_construction_protocol'])
