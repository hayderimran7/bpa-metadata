...
def add_data(data):
    ...
    for entry in data:
        ...
        if sample:
            ...
            sample.study_title = entry.study_title
            sample.investigation_type = entry.investigation_type
            ...
            sample.collected_by = entry.collected_by
            ...
            host, _ = Host.objects.get_or_create(description=entry.host_description,
                                                 ...
                                                 associated=entry.host_associated,
                                                 health_state=entry.host_health_state,
                                                 disease_status=entry.host_disease_status,)
            sample.host = host
