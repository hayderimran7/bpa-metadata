...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('sepsis', '0017_auto_20160824_1147'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'MiSeq Tracking Information',
            },
        ),
        migrations.AlterModelOptions(
            name='pacbiotrack',
            options={'verbose_name': 'PacBio Tracking Information', 'verbose_name_plural': 'PacBio Tracking Information'},
        ),
    ]
