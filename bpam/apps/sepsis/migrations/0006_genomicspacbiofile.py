    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method', models.ForeignKey(related_name='sepsis_genomicspacbiofile_files', to='sepsis.PacBioGenomicsMethod', help_text=b'PacBio Genomics Method', null=True)),
                ('sample', models.ForeignKey(to='sepsis.SepsisSample')),
                ('url_verification', models.ForeignKey(related_name='sepsis_genomicspacbiofile_related', to='common.URLVerification', null=True)),
            ],
            options={
                'abstract': False,
            },
