    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('growth_condition_media', models.IntegerField(null=True, verbose_name=b'Growth condition media', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('host_description', models.CharField(max_length=200, null=True, verbose_name=b'Host Description', blank=True)),
                ('host_location', models.CharField(help_text=b'State, Country', max_length=200, null=True, verbose_name=b'Host Location', blank=True)),
                ('host_sex', models.CharField(blank=True, max_length=1, null=True, verbose_name=b'Host Sex', choices=[(b'M', b'Male'), (b'F', b'Female')])),
                ('host_age', models.IntegerField(null=True, verbose_name=b'Host Age', blank=True)),
                ('host_dob', models.DateField(help_text=b'DD/MM/YY', null=True, verbose_name=b'Host Day of Birth', blank=True)),
                ('host_disease_outcome', models.TextField(null=True, verbose_name=b'Host Disease Outcome', blank=True)),
            ],
            options={
                'verbose_name': 'Hosts',
            },
        ...
        migrations.CreateModel(
            ...
            options={
                'abstract': False,
                'verbose_name': 'Growth Methods',
            },
        ),
        migrations.CreateModel(
            name='SepsisSample',
            fields=[
                ('bpa_id', models.OneToOneField(primary_key=True, serialize=False, to='common.BPAUniqueID', verbose_name=b'BPA ID')),
