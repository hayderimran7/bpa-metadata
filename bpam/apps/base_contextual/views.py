...
def get_matrix_csv(request):
    field_header_map = {
        ...
        'site__crop_rotation_1__description': 'Crop Rotation 1',
        'site__crop_rotation_2__description': 'Crop Rotation 2',
        'site__crop_rotation_3__description': 'Crop Rotation 3',
        'site__crop_rotation_4__description': 'Crop Rotation 4',
        'site__crop_rotation_5__description': 'Crop Rotation 5',
    ...
    qs = SampleContext.objects.values('bpa_id',
                                      ...
                                      'site__crop_rotation_1__description',
                                      'site__crop_rotation_2__description',
                                      'site__crop_rotation_3__description',
                                      'site__crop_rotation_4__description',
                                      'site__crop_rotation_5__description',
