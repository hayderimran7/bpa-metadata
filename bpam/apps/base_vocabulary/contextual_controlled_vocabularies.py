...
def load(orm):
    ...
    for classification, note in AustralianSoilClassificationVocabulary:
        t = orm.AustralianSoilClassification.objects.create()
        t.classification = classification
        t.note = note
        t.save()

    for description, note in EcologicalZoneVocabulary:
        t = orm.GeneralEcologicalZone.objects.create()
        t.description = description
        t.note = note
        t.save()

    for classification, note in FAOSoilClassificationVocabulary:
        t = orm.FAOSoilClassification.objects.create()
        t.classification = classification
        t.note = note
        t.save()
    ...
    for tillage, description in TillageClassificationVocabulary:
        t = orm.TillageType.objects.create()
        t.tillage = tillage
        t.description = description
        t.save()
