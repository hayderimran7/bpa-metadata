...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('array_analysis_facility', models.ForeignKey(related_name='+',
                                                              ...
                                                              to='common.Facility',
                                                              null=True)),
                ('protocol', models.ForeignKey(blank=True,
                                               to='wheat_pathogens_transcript.WheatPathogenTranscriptProtocol',
                                               null=True)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_scientist', models.ForeignKey(
                    related_name='wheat_pathogens_transcript_wheatpathogentranscriptsample_sample',
                    blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url_verification', models.ForeignKey(
                    related_name='wheat_pathogens_transcript_wheatpathogentranscriptsequencefile_related',
        ...
        migrations.AddField(model_name='wheatpathogentranscriptrun',
                            name='sample',
        ...
        migrations.AddField(model_name='wheatpathogentranscriptrun',
                            ...
                            field=models.ForeignKey(related_name='+',
                                                    ...
                                                    to='common.Facility',
                                                    null=True), ),
        migrations.AddField(model_name='wheatpathogentranscriptprotocol',
                            name='run',
                            field=models.ForeignKey(blank=True,
                                                    to='wheat_pathogens_transcript.WheatPathogenTranscriptRun',
                                                    null=True), ),
