    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_scientist', models.ForeignKey(related_name='wheat_pathogens_transcript_wheatpathogentranscriptsample_sample', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('dna_source', models.ForeignKey(related_name='wheat_pathogens_transcript_wheatpathogentranscriptsample_sample', verbose_name='DNA Source', blank=True, to='common.DNASource', null=True)),
            ],
            options={
                'abstract': False,
                'verbose_name': 'Sample',
