...
class Sample454Admin(admin.ModelAdmin):
    ...
    fieldsets = [
        (None, {'fields': ('bpa_id',
                           ...
                           'agrf_batch_number',
                           'submitter',
                           'date_received', )}), ('DNA Storage', {'fields': ('dna_storage_nunc_plate',
                                                                             'dna_storage_nunc_tube',
                                                                             'dna_storage_nunc_well_location', )}),
        ('AGRF Adelaide Extraction',
         {'description': 'Extracted at Adelaide Node',
          'fields':
          ('adelaide_extraction_sample_weight', 'adelaide_fluorimetry', 'adelaide_pcr_inhibition', 'adelaide_pcr1',
           'adelaide_pcr2', 'adelaide_date_shipped_to_agrf_454', 'adelaide_date_shipped_to_agrf_miseq',
           'adelaide_date_shipped_to_ramacciotti')}), ('Brisbane 454', {'description': 'Extracted at Brisbane Node',
                                                                        'fields':
                                                                        ('brisbane_16s_mid',
                                                                         'brisbane_its_mid',
                                                                         'brisbane_16s_pcr1',
                                                                         ...
                                                                         'brisbane_16s_reads',
                                                                         'brisbane_its_reads', )}),
        ('Comments and Notes', {'description': 'Any notes or comments on this Extraction',
