...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='MMSample',
            fields=[
                ('bpa_id', models.OneToOneField(primary_key=True, serialize=False, to='common.BPAUniqueID', help_text=b'Bioplatforms Australia Sample ID', verbose_name=b'BPA ID')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='marine_microbes_metagenomisequencefile_related', to='common.URLVerification', null=True),
        ),
    ]
