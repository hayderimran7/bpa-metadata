...
class SampleAdmin(admin.ModelAdmin):
    fieldsets = [
        ...
        ('Sequencing', {'fields': [('dna_source', 'library', 'index_number'),
        ...
        ('Data', {'fields' : [('sequence_facility_filename', 'md5cheksum'),
                              'BPA_archive_url',
                              ('analysed', 'analysed_url'),
                              'ftp_url',
                              ('date_sent_to_sequencing_facility', 'date_recieved_from_sequencing_facility')
                              ]
                  }
         ),
